#
# Module manifest for module 'code365scripts'
#
# Generated by: 陈希章
#
...
@{
    ...
    RequiredModules   = @(@{ModuleName = 'code365scripts.teams'; ModuleVersion = '0.0.9.2'; },@{ModuleName = 'code365scripts.weixin'; ModuleVersion = '0.0.2.2'; })
